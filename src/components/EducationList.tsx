          ...
          <li key={edu.id} className="mb-2">
            {editingId === edu.id && !readOnly ? (
              <div className="space-y-2">
                <input className="input input-bordered w-full" name="degree" value={form.degree || ""} onChange={handleChange} placeholder="Uddannelse" title="Uddannelse" />
                <input className="input input-bordered w-full" name="institution" value={form.institution || ""} onChange={handleChange} placeholder="Institution" title="Institution" />
