...
export class ProfileApi extends runtime.BaseAPI {
    ...
    async createProfileRaw(requestParameters: CreateProfileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ProfileDto>> {
        if (requestParameters['profileCreateRequest'] == null) {
            throw new runtime.RequiredError(
                'profileCreateRequest',
                'Required parameter "profileCreateRequest" was null or undefined when calling createProfile().'
            );
        }
    ...
    /**
     */
    async importLinkedInProfileRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ProfileDto>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async importLinkedInProfile(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ProfileDto> {
    ...
    async updateProfileRaw(requestParameters: UpdateProfileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        if (requestParameters['profileUpdateRequest'] == null) {
            throw new runtime.RequiredError(
                'profileUpdateRequest',
                'Required parameter "profileUpdateRequest" was null or undefined when calling updateProfile().'
            );
        }
