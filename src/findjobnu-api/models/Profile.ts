...
import type { JobAgent } from './JobAgent';
import {
    JobAgentFromJSON,
    JobAgentFromJSONTyped,
    JobAgentToJSON,
    JobAgentToJSONTyped,
} from './JobAgent';
...
export function ProfileFromJSONTyped(json: any, ignoreDiscriminator: boolean): Profile {
    ...
    return {
        ...
        'jobAgent': json['jobAgent'] == null ? undefined : JobAgentFromJSON(json['jobAgent']),
    };
}
...
export function ProfileToJSONTyped(value?: Profile | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'jobAgent': JobAgentToJSON(value['jobAgent']),
    };
}
